...
public class DownloadRecursiveFolderFromSFTP {
    ...
    public static void main(String[] args) {
        String SFTPHOST = "172.16.12.22"; // SFTP Host Name or SFTP Host IP Address
        int SFTPPORT = 22; // SFTP Port Number
        String SFTPUSER = "root"; // User Name
        String SFTPPASS = "flineCloud@2020root"; // Password
        String SFTPWORKINGDIR = "/data/dyn/fline-hell-pvc-4d49a9ee-e674-11ea-bff5-005056b17256/a"; // Source Directory on SFTP server
