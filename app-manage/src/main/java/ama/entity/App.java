...
public class App implements Serializable {
    ...
    @ApiModelProperty(value = "域名,域名,以分号隔开多组，以逗号隔开ip和域名：172.15.64.2,google.com,baidu.com;172.232.232.2,a.b.com")
    @Column(columnDefinition = "varchar(150) COMMENT '域名'")
    private String dominName;        //域名格式：172.15.64.2,google.com,baidu.com;172.232.232.2,a.b.com
